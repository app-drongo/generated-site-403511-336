// Enhanced by AI on 2025-08-17T07:39:48.964Z
// Section: hero
// Category: hero
        ...
        <div className="relative pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-32 lg:pb-28">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
              As a web developer with 15 years of experience in both frontend and backend, I can create stunning, high-performance websites with cutting-edge tools and templates. Turn your ideas into reality faster than ever before.
            </p>
